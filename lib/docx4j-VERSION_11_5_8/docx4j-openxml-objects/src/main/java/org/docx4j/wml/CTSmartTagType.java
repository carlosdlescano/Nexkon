...
/**
 * <p>Java class for CT_SmartTagType complex type.
 * 
...
@XmlType(name = "CT_SmartTagType")
public class CTSmartTagType implements Child
{

    @XmlAttribute(name = "namespaceuri", namespace = "http://schemas.openxmlformats.org/wordprocessingml/2006/main")
    protected String namespaceuri;
    @XmlAttribute(name = "name", namespace = "http://schemas.openxmlformats.org/wordprocessingml/2006/main")
    protected String name;
    @XmlAttribute(name = "url", namespace = "http://schemas.openxmlformats.org/wordprocessingml/2006/main")
