...
/**
 * <p>Java class for CT_SdtCell complex type.
 * 
...
@XmlType(name = "CT_SdtCell", propOrder = {
    "sdtPr",
    "sdtEndPr",
    "sdtContent"
})
@XmlRootElement(name = "sdt")
public class CTSdtCell implements SdtElement, Child
{

    protected SdtPr sdtPr;
    protected CTSdtEndPr sdtEndPr;
    protected CTSdtContentCell sdtContent;
    @XmlTransient
