...
/**
 * <p>Java class for CT_RubyContent complex type.
 * 
...
@XmlType(name = "CT_RubyContent", propOrder = {
    "egRubyContent"
})
public class CTRubyContent implements Child
{
    ...
    protected List<Object> egRubyContent  = new ArrayListWml<Object>(this);
    @XmlTransient
    private Object parent;

    /**
     * Gets the value of the egRubyContent property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the egRubyContent property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEGRubyContent().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getEGRubyContent() {
        if (egRubyContent == null) {
            egRubyContent  = new ArrayListWml<Object>(this);
        }
        return this.egRubyContent;
    }
