...
/**
 * <p>Java class for CT_OsfWebExtensionPropertyBag complex type.
 * 
...
public class CTOsfWebExtensionPropertyBag implements Child
{
    ...
    protected List<CTOsfWebExtensionProperty> property;
    @XmlTransient
     ...
     * 
     */
    public List<CTOsfWebExtensionProperty> getProperty() {
        if (property == null) {
            property = new ArrayList<CTOsfWebExtensionProperty>();
        }
