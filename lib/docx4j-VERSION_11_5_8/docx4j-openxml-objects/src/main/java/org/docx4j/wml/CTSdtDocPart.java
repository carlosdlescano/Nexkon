...
/**
 * <p>Java class for CT_SdtDocPart complex type.
 * 
...
@XmlType(name = "CT_SdtDocPart", propOrder = {
    "docPartGallery",
    "docPartCategory",
    "docPartUnique"
})
public class CTSdtDocPart implements Child
{
     ...
     * @return
     *     possible object is
     *     {@link CTSdtDocPart.DocPartGallery }
     *     
     */
     ...
     * @return
     *     possible object is
     *     {@link CTSdtDocPart.DocPartCategory }
     *     
     */
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class DocPartCategory implements Child
    {
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class DocPartGallery implements Child
    {
