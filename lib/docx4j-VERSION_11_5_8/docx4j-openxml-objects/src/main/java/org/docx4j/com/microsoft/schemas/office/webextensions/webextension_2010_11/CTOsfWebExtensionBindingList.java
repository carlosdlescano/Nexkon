...
/**
 * <p>Java class for CT_OsfWebExtensionBindingList complex type.
 * 
...
public class CTOsfWebExtensionBindingList implements Child
{
    ...
    protected List<CTOsfWebExtensionBinding> binding;
    @XmlTransient
     ...
     * 
     */
    public List<CTOsfWebExtensionBinding> getBinding() {
        if (binding == null) {
            binding = new ArrayList<CTOsfWebExtensionBinding>();
        }
        return this.binding;
    }
