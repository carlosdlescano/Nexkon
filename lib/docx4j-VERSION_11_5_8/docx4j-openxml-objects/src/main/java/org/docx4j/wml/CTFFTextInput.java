...
/**
 * <p>Java class for CT_FFTextInput complex type.
 * 
...
@XmlType(name = "CT_FFTextInput", propOrder = {
    "type",
    "_default",
    "maxLength",
    "format"
})
public class CTFFTextInput implements Child
{
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class Format implements Child
    {
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class MaxLength implements Child
    {
