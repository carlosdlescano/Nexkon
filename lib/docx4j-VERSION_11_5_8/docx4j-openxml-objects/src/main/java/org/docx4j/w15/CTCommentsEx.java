...
@XmlRootElement(name="commentsEx")
public class CTCommentsEx implements Child
{

    protected List<CTCommentEx> commentEx;
    @XmlTransient
     ...
     * 
     */
    public List<CTCommentEx> getCommentEx() {
        if (commentEx == null) {
            commentEx = new ArrayList<CTCommentEx>();
        }
