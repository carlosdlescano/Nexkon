...
/**
 * <p>Java class for ST_PTabRelativeTo.
 * 
...
public enum STPTabRelativeTo {
    ...
    public static STPTabRelativeTo fromValue(String v) {
        for (STPTabRelativeTo c: STPTabRelativeTo.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
