...
public class CTRelativeRect implements Child
{
    ...
    @XmlAttribute(name = "l", namespace = "http://schemas.microsoft.com/office/word/2010/wordml")
    protected Integer l;
    @XmlAttribute(name = "t", namespace = "http://schemas.microsoft.com/office/word/2010/wordml")
    protected Integer t;
    @XmlAttribute(name = "r", namespace = "http://schemas.microsoft.com/office/word/2010/wordml")
    protected Integer r;
    @XmlAttribute(name = "b", namespace = "http://schemas.microsoft.com/office/word/2010/wordml")
    protected Integer b;
    @XmlTransient
