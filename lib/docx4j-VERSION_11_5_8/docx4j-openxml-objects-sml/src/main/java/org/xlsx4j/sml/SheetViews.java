...
/**
 * <p>Java class for CT_SheetViews complex type.
 * 
...
@XmlType(name = "CT_SheetViews", propOrder = {
    "sheetView",
    "extLst"
})
@XmlRootElement(name = "sheetViews")
public class SheetViews implements Child
{

    @XmlElement(required = true)
    protected List<SheetView> sheetView;
     ...
     * 
     */
    public List<SheetView> getSheetView() {
        if (sheetView == null) {
            sheetView = new ArrayList<SheetView>();
        }
