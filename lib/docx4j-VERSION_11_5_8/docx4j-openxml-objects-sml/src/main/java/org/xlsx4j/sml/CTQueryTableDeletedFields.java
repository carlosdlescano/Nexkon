...
/**
 * <p>Java class for CT_QueryTableDeletedFields complex type.
 * 
...
@XmlType(name = "CT_QueryTableDeletedFields", propOrder = {
    "deletedField"
})
public class CTQueryTableDeletedFields implements Child
{

    @XmlElement(required = true)
    protected List<CTDeletedField> deletedField;
     ...
     * 
     */
    public List<CTDeletedField> getDeletedField() {
        if (deletedField == null) {
            deletedField = new ArrayList<CTDeletedField>();
        }
