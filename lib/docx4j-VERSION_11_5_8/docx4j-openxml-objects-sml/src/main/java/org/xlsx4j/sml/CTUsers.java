...
/**
 * <p>Java class for CT_Users complex type.
 * 
...
@XmlType(name = "CT_Users", propOrder = {
    "userInfo"
})
public class CTUsers implements Child
{

    protected List<CTSharedUser> userInfo;
     ...
     * 
     */
    public List<CTSharedUser> getUserInfo() {
        if (userInfo == null) {
            userInfo = new ArrayList<CTSharedUser>();
        }
