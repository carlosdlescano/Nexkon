...
/**
 * <p>Java class for CT_GroupMembers complex type.
 * 
...
@XmlType(name = "CT_GroupMembers", propOrder = {
    "groupMember"
})
public class CTGroupMembers implements Child
{

    @XmlElement(required = true)
    protected List<CTGroupMember> groupMember;
     ...
     * 
     */
    public List<CTGroupMember> getGroupMember() {
        if (groupMember == null) {
            groupMember = new ArrayList<CTGroupMember>();
        }
