...
/**
 * <p>Java class for CT_ColHierarchiesUsage complex type.
 * 
...
public class CTColHierarchiesUsage implements Child
{
    ...
    /**
     * Gets the value of the colHierarchyUsage property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the colHierarchyUsage property.
     * 
     * <p>
    ...
    public List<CTHierarchyUsage> getColHierarchyUsage() {
        if (colHierarchyUsage == null) {
            colHierarchyUsage = new ArrayList<CTHierarchyUsage>();
        }
