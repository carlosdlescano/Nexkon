...
/**
 * <p>Java class for CT_ServerFormats complex type.
 * 
...
@XmlType(name = "CT_ServerFormats", propOrder = {
    "serverFormat"
})
public class CTServerFormats implements Child
{
    ...
    /**
     * Gets the value of the serverFormat property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the serverFormat property.
     * 
     * <p>
    ...
    public List<CTServerFormat> getServerFormat() {
        if (serverFormat == null) {
            serverFormat = new ArrayList<CTServerFormat>();
        }
