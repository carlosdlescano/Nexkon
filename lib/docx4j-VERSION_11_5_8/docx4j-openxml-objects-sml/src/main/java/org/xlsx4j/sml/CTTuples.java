...
/**
 * <p>Java class for CT_Tuples complex type.
 * 
...
@XmlType(name = "CT_Tuples", propOrder = {
    "tpl"
})
public class CTTuples implements Child
{

    @XmlElement(required = true)
    protected List<CTTuple> tpl;
    @XmlAttribute(name = "c")
     ...
     * 
     */
    public List<CTTuple> getTpl() {
        if (tpl == null) {
            tpl = new ArrayList<CTTuple>();
        }
        return this.tpl;
    }
