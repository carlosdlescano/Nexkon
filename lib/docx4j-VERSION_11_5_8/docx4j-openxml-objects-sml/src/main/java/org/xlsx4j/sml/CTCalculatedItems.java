...
/**
 * <p>Java class for CT_CalculatedItems complex type.
 * 
...
public class CTCalculatedItems implements Child
{
    ...
    /**
     * Gets the value of the calculatedItem property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the calculatedItem property.
     * 
     * <p>
    ...
    public List<CTCalculatedItem> getCalculatedItem() {
        if (calculatedItem == null) {
            calculatedItem = new ArrayList<CTCalculatedItem>();
        }
