...
/**
 * <p>Java class for CT_ExternalRow complex type.
 * 
...
@XmlType(name = "CT_ExternalRow", propOrder = {
    "cell"
})
public class CTExternalRow implements Child
{

    protected List<CTExternalCell> cell;
    ...
    public List<CTExternalCell> getCell() {
        if (cell == null) {
            cell = new ArrayList<CTExternalCell>();
        }
        return this.cell;
    }
