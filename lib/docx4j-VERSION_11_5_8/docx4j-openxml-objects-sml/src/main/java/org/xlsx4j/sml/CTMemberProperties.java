...
/**
 * <p>Java class for CT_MemberProperties complex type.
 * 
...
@XmlType(name = "CT_MemberProperties", propOrder = {
    "mp"
})
public class CTMemberProperties implements Child
{

    @XmlElement(required = true)
    protected List<CTMemberProperty> mp;
     ...
     * {@link CTMemberProperty }
     * 
     * 
     */
    public List<CTMemberProperty> getMp() {
        if (mp == null) {
            mp = new ArrayList<CTMemberProperty>();
        }
        return this.mp;
    }
