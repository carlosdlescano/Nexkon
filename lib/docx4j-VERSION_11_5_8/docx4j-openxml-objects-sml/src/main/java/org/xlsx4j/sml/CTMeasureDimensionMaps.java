...
/**
 * <p>Java class for CT_MeasureDimensionMaps complex type.
 * 
...
@XmlType(name = "CT_MeasureDimensionMaps", propOrder = {
    "map"
})
public class CTMeasureDimensionMaps implements Child
{

    protected List<CTMeasureDimensionMap> map;
     ...
     * {@link CTMeasureDimensionMap }
     * 
     * 
     */
    public List<CTMeasureDimensionMap> getMap() {
        if (map == null) {
            map = new ArrayList<CTMeasureDimensionMap>();
        }
        return this.map;
    }
