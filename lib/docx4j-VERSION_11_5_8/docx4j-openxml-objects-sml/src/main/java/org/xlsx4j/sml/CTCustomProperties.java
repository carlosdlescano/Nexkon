...
/**
 * <p>Java class for CT_CustomProperties complex type.
 * 
...
@XmlType(name = "CT_CustomProperties", propOrder = {
    "customPr"
})
public class CTCustomProperties implements Child
{
    ...
    /**
     * Gets the value of the customPr property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the customPr property.
     * 
     * <p>
     ...
     * {@link CTCustomProperty }
     * 
     * 
     */
    public List<CTCustomProperty> getCustomPr() {
        if (customPr == null) {
            customPr = new ArrayList<CTCustomProperty>();
        }
