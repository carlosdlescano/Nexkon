...
/**
 * <p>Java class for CT_CacheFields complex type.
 * 
...
public class CTCacheFields implements Child
{
    ...
    /**
     * Gets the value of the cacheField property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the cacheField property.
     * 
     * <p>
    ...
    public List<CTCacheField> getCacheField() {
        if (cacheField == null) {
            cacheField = new ArrayList<CTCacheField>();
        }
