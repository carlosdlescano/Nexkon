...
/**
 * <p>Java class for CT_CacheHierarchies complex type.
 * 
...
public class CTCacheHierarchies implements Child
{
    ...
    /**
     * Gets the value of the cacheHierarchy property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the cacheHierarchy property.
     * 
     * <p>
    ...
    public List<CTCacheHierarchy> getCacheHierarchy() {
        if (cacheHierarchy == null) {
            cacheHierarchy = new ArrayList<CTCacheHierarchy>();
        }
