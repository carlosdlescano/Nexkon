...
/**
 * <p>Java class for CT_Members complex type.
 * 
...
@XmlType(name = "CT_Members", propOrder = {
    "member"
})
public class CTMembers implements Child
{

    @XmlElement(required = true)
    protected List<CTMember> member;
     ...
     * 
     */
    public List<CTMember> getMember() {
        if (member == null) {
            member = new ArrayList<CTMember>();
        }
        return this.member;
    }
