...
/**
 * <p>Java class for CT_QueryCache complex type.
 * 
...
@XmlType(name = "CT_QueryCache", propOrder = {
    "query"
})
public class CTQueryCache implements Child
{

    @XmlElement(required = true)
    protected List<CTQuery> query;
     ...
     * 
     */
    public List<CTQuery> getQuery() {
        if (query == null) {
            query = new ArrayList<CTQuery>();
        }
        return this.query;
    }
