...
/**
 * <p>Java class for CT_PivotAreas complex type.
 * 
...
@XmlType(name = "CT_PivotAreas", propOrder = {
    "pivotArea"
})
public class CTPivotAreas implements Child
{

    protected List<CTPivotArea> pivotArea;
     ...
     * This is why there is not a <CODE>set</CODE> method for the pivotArea property.
     * 
     * <p>
     ...
     * 
     */
    public List<CTPivotArea> getPivotArea() {
        if (pivotArea == null) {
            pivotArea = new ArrayList<CTPivotArea>();
        }
