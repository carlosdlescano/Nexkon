...
/**
 * <p>Java class for CT_PCDKPIs complex type.
 * 
...
@XmlType(name = "CT_PCDKPIs", propOrder = {
    "kpi"
})
public class CTPCDKPIs implements Child
{

    protected List<CTPCDKPI> kpi;
     ...
     * 
     */
    public List<CTPCDKPI> getKpi() {
        if (kpi == null) {
            kpi = new ArrayList<CTPCDKPI>();
        }
        return this.kpi;
    }
