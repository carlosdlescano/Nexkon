...
/**
 * <p>Java class for CT_MetadataTypes complex type.
 * 
...
@XmlType(name = "CT_MetadataTypes", propOrder = {
    "metadataType"
})
public class CTMetadataTypes implements Child
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the metadataType property.
     * 
     * <p>
    ...
    public List<CTMetadataType> getMetadataType() {
        if (metadataType == null) {
            metadataType = new ArrayList<CTMetadataType>();
        }
