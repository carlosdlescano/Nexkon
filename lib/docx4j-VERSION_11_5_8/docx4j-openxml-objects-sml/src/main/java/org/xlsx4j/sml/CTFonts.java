...
/**
 * <p>Java class for CT_Fonts complex type.
 * 
...
@XmlType(name = "CT_Fonts", propOrder = {
    "font"
})
public class CTFonts implements Child
{

    protected List<CTFont> font;
     ...
     * 
     */
    public List<CTFont> getFont() {
        if (font == null) {
            font = new ArrayList<CTFont>();
        }
        return this.font;
    }
