...
/**
 * <p>Java class for CT_DdeValue complex type.
 * 
...
@XmlType(name = "CT_DdeValue", propOrder = {
    "val"
})
public class CTDdeValue implements Child
{

    @XmlElement(required = true)
    protected String val;
    @XmlAttribute(name = "t")
    protected STDdeValueType t;
    @XmlTransient
     ...
     *     
     */
    public STDdeValueType getT() {
        if (t == null) {
            return STDdeValueType.N;
        } else {
            return t;
        }
    }
     ...
     *     
     */
    public void setT(STDdeValueType value) {
        this.t = value;
    }
