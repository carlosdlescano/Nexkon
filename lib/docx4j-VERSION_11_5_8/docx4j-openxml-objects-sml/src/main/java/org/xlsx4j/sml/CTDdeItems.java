...
/**
 * <p>Java class for CT_DdeItems complex type.
 * 
...
@XmlType(name = "CT_DdeItems", propOrder = {
    "ddeItem"
})
public class CTDdeItems implements Child
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the ddeItem property.
     * 
     * <p>
    ...
    public List<CTDdeItem> getDdeItem() {
        if (ddeItem == null) {
            ddeItem = new ArrayList<CTDdeItem>();
        }
        return this.ddeItem;
    }
