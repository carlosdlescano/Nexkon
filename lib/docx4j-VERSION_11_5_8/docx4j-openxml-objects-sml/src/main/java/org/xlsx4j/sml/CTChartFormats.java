...
/**
 * <p>Java class for CT_ChartFormats complex type.
 * 
...
public class CTChartFormats implements Child
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the chartFormat property.
     * 
     * <p>
    ...
    public List<CTChartFormat> getChartFormat() {
        if (chartFormat == null) {
            chartFormat = new ArrayList<CTChartFormat>();
        }
