...
/**
 * <p>Java class for CT_Sets complex type.
 * 
...
@XmlType(name = "CT_Sets", propOrder = {
    "set"
})
public class CTSets implements Child
{

    @XmlElement(required = true)
    protected List<CTSet> set;
     ...
     * 
     */
    public List<CTSet> getSet() {
        if (set == null) {
            set = new ArrayList<CTSet>();
        }
        return this.set;
    }
