...
/**
 * <p>Java class for CT_PivotFilters complex type.
 * 
...
@XmlType(name = "CT_PivotFilters", propOrder = {
    "filter"
})
public class CTPivotFilters implements Child
{

    protected List<CTPivotFilter> filter;
     ...
     * 
     */
    public List<CTPivotFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<CTPivotFilter>();
        }
        return this.filter;
    }
