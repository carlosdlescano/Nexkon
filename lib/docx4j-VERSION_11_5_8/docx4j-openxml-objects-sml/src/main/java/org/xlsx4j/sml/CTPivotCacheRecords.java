...
/**
 * <p>Java class for CT_PivotCacheRecords complex type.
 * 
...
@XmlType(name = "CT_PivotCacheRecords", propOrder = {
    "r",
    "extLst"
})
@XmlRootElement(name = "pivotCacheRecords")
public class CTPivotCacheRecords implements Child
{
     ...
     * 
     */
    public List<CTRecord> getR() {
        if (r == null) {
            r = new ArrayList<CTRecord>();
        }
        return this.r;
    }
