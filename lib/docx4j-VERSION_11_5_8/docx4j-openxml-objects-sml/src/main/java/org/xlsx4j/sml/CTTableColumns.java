...
/**
 * <p>Java class for CT_TableColumns complex type.
 * 
...
@XmlType(name = "CT_TableColumns", propOrder = {
    "tableColumn"
})
public class CTTableColumns implements Child
{

    @XmlElement(required = true)
    protected List<CTTableColumn> tableColumn;
     ...
     * 
     */
    public List<CTTableColumn> getTableColumn() {
        if (tableColumn == null) {
            tableColumn = new ArrayList<CTTableColumn>();
        }
