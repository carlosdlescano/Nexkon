...
/**
 * <p>Java class for CT_CellSmartTags complex type.
 * 
...
public class CTCellSmartTags implements Child
{
    ...
    /**
     * Gets the value of the cellSmartTag property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the cellSmartTag property.
     * 
     * <p>
    ...
    public List<CTCellSmartTag> getCellSmartTag() {
        if (cellSmartTag == null) {
            cellSmartTag = new ArrayList<CTCellSmartTag>();
        }
