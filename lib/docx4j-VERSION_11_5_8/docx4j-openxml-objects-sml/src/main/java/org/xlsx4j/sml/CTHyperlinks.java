...
/**
 * <p>Java class for CT_Hyperlinks complex type.
 * 
...
@XmlType(name = "CT_Hyperlinks", propOrder = {
    "hyperlink"
})
public class CTHyperlinks implements Child
{
    ...
    public List<CTHyperlink> getHyperlink() {
        if (hyperlink == null) {
            hyperlink = new ArrayList<CTHyperlink>();
        }
