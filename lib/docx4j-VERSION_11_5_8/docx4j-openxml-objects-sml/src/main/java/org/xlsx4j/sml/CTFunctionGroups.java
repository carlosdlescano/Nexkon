...
/**
 * <p>Java class for CT_FunctionGroups complex type.
 * 
...
@XmlType(name = "CT_FunctionGroups", propOrder = {
    "functionGroup"
})
public class CTFunctionGroups implements Child
{

    protected List<CTFunctionGroup> functionGroup;
    @XmlAttribute(name = "builtInGroupCount")
    @XmlSchemaType(name = "unsignedInt")
    protected Long builtInGroupCount;
    @XmlTransient
     ...
     * {@link CTFunctionGroup }
     * 
     * 
     */
    public List<CTFunctionGroup> getFunctionGroup() {
        if (functionGroup == null) {
            functionGroup = new ArrayList<CTFunctionGroup>();
        }
        return this.functionGroup;
    }

    /**
     * Gets the value of the builtInGroupCount property.
     * 
     * @return
     *     possible object is
     *     {@link Long }
    ...
    public long getBuiltInGroupCount() {
        if (builtInGroupCount == null) {
            ...
            return builtInGroupCount;
        }
    }

    /**
     * Sets the value of the builtInGroupCount property.
     * 
     * @param value
     *     allowed object is
     *     {@link Long }
     *     
     */
    public void setBuiltInGroupCount(Long value) {
        this.builtInGroupCount = value;
    }
