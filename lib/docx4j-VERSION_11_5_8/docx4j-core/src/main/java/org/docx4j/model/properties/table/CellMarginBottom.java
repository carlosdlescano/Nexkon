...
public class CellMarginBottom extends AbstractCellMargin {
	...
	protected static final String SUFFIX = "bottom";
	
	public CellMarginBottom(TblWidth tblWidth) {
		super(tblWidth, SUFFIX);
	}

	public CellMarginBottom(CSSValue value) {
		super(value, SUFFIX);
	}
	...
	public void set(TcPrInner tcPr) {
		ensureMargin(tcPr);
		tcPr.getTcMar().setBottom((TblWidth)getObject());
	}
